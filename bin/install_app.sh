...
envsubst < $repository_root_dir/binanceB/kubernetes/app/2-mongodb/3-mongodb-secrets.yaml | sudo tee /home/$USER/temp/3-mongodb/3-mongodb-secrets.yaml > /dev/null
