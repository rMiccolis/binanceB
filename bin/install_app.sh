...
envsubst < $repository_root_dir/binanceB/kubernetes/app/4-client/3-client-configmap.yaml | sudo tee /home/$USER/temp/4-client/3-client-configmap.yaml > /dev/null
