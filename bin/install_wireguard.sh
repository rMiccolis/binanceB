...
SaveConfig = true
PostUp = iptables -A FORWARD -m iprange --src-range 10.11.1.50-10.11.1.200 -i %i -d 192.168.1.0/24 -j ACCEPT; iptables -A FORWARD -o %i -j ACCEPT; iptables -t nat -A POSTROUTING -o eth0 -j MASQUERADE;
