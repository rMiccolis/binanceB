...
echo -e "${GREEN}Phase 1 / 10 ===> Operation Done!${WHITE}"


echo -e "${LGREEN}Starting phase 2 / 10 ===> Installing Docker${WHITE}"
./binanceB/bin/install_docker.sh
echo -e "${GREEN}Phase 2 / 10 ===> Operation Done!${WHITE}"
...
echo -e "${GREEN}Login succeded!!${WHITE}"
...
echo -e "${GREEN}Phase 8 / 10 ===> Operation Done!${WHITE}"
...
echo -e "${GREEN}Phase 9 / 10 ===> Operation Done!${WHITE}"
...
echo -e "${GREEN}Phase 10 / 10 ===> Operation Done!${WHITE}"
